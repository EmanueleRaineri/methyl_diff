...
#######
echo "Z score on tp"
python zscore.py < tp.txt |awk '{print $2}' > zscore_of_tp_${COV1}_${COV2}.txt
python zscore.py < tn.txt |awk '{print $2}' > zscore_of_tn_${COV1}_${COV2}.txt
#######
echo "compute power"
#fisher
python compute_power.py fisher_of_tp_${COV1}_${COV2}.txt fisher_of_tn_${COV1}_${COV2}.txt > fisher.roc.${COV1}_${COV2}.txt
#z score
python compute_power.py zscore_of_tp_${COV1}_${COV2}.txt zscore_of_tn_${COV1}_${COV2}.txt > zscore.roc.${COV1}_${COV2}.txt
#beta
python compute_power_beta.py beta_of_tp_${COV1}_${COV2}.txt beta_of_tn_${COV1}_${COV2}.txt > beta.roc.${COV1}_${COV2}.txt
#######
paste fisher.roc.${COV1}_${COV2}.txt beta.roc.${COV1}_${COV2}.txt zscore.roc.${COV1}_${COV2}.txt > roc_${COV1}_${COV2}.txt
...
cat zscore_of_tp_${COV1}_${COV2}.txt zscore_of_tn_${COV1}_${COV2}.txt > zscore_${COV1}_${COV2}.txt 
paste fisher_${COV1}_${COV2}.txt beta_${COV1}_${COV2}.txt zscore_${COV1}_${COV2}.txt > fisher_beta_zscore_${COV1}_${COV2}.txt
#######
#plot with plot_roc.py fisher.roc zscore.roc beta.roc
